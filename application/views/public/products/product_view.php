...
foreach ($category->pagination as $category)
{
	...
	array_push($breadcrumbs, array(
		'name' => $category->name,
		'link' => 'category/'.$category->slug.'/'.$category->name
	));
}
...
<?php if ($related_products): ?>
	<div class="breadcrumb" style="margin-top:5rem">Related Products</div>
...
<?php echo form_open(current_url().'#form', 'class="tumbnail"') ?>
	...
	<div class="lead" style="margin-bottom:5rem">Ask about the product</div>
