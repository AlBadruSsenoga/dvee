<?php foreach ($descriptions as $description): ?>
    <li class="list-group-item app-description">
        <?= $description->name ?>
        <i class="fa fa-close pull-right app-description-delete" data-key="<?= $description->id ?>"></i>
    </li>
<?php endforeach ?>
...
$('.app-description-delete').click(function(){
    ...
    $.ajax({
        ...
        beforeSend: function(){
            ...
            icon.addClass('fa fa-spinner pull-right');
        },
        ...
        complete: function(){
            icon.removeClass('fa fa-spinner pull-right');
