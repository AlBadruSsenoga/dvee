...
<div class="page-header b-0">
    <div class="lead pull-left">Attributes for <code><?php echo $category->name ?></code></div>
    <button class="btn btn-primary pull-right" data-toggle="modal" data-target="#attributes-add-modal">
        <span class="glyphicon glyphicon-plus"></span> Attribute
    </button>
                    ...
                    <tr>
                        ...
                        <th class="text-center">
                            <div data-toggle="tooltip" data-placement="bottom" title="Use attribute as a Product Option. Product options are used to create product variations">
                                Product Option <span class="glyphicon glyphicon-info-sign"></span>
                            </div>
                        </th>
