...
<div class="page-header b-0">
	...
	<a href="<?php echo $base_url; ?>admin/shipping_rates/<?php echo $shipping_data[$this->flexi_cart_admin->db_column('shipping_options', 'id')];?>" class="btn btn-success pull-right">
