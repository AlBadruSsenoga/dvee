...
<div class="page-header b-0">
	...
	<?php echo anchor('admin/insert_shipping_rate/'.$shipping_data[$this->flexi_cart_admin->db_column('shipping_options', 'id')], 'Insert New Shipping Rate', 'class="pull-right btn btn-primary"') ?>
