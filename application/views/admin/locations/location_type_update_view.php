...
<div class="page-header b-0">
	<div class="lead pull-left">Locations Types</div>
	<a href="<?php echo site_url('admin/insert_location_type') ?>" class="btn btn-primary pull-right">
		<span class="glyphicon glyphicon-plus"></span> Location Type
	</a>
				...
				<tr>
					<th>
						<div data-toggle="tooltip" title="The name for the type of locations that will be related. For example, 'Country', 'State' etc.">
							Location Type <span class="glyphicon glyphicon-info-sign"></span>
						</div>
					</th>
					<th>
						<div data-toggle="tooltip" title="Sets the location types 'Parent'. For Example, 'State' would have 'Country' as its parent.">
							Parent Location Type <span class="glyphicon glyphicon-info-sign"></span> 
						</div>
					</th>
