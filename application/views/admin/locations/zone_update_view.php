...
<div class="page-header b-0">
	<div class="lead pull-left">Locations Zones</div>
	<a href="<?php echo site_url('admin/insert_zone') ?>" class="btn btn-primary pull-right">
		<span class="glyphicon glyphicon-plus"></span> Zone
	</a>
