...
<div class="page-header b-0">
	<div class="lead pull-left">Manage <?php echo $location_type_data[$this->flexi_cart_admin->db_column('location_type', 'name')] ?> Locations</div>
	<a href="<?php echo site_url('admin/insert_location/'.$location_type_data[$this->flexi_cart_admin->db_column('location_type', 'id')]) ?>" class="btn btn-success pull-right">
				...
				<tr>
					...
					<th>
						<div data-toggle="tooltip" title="Locations can be grouped together with other non-related locations into Shipping Zones. Shipping rates can then be applied to all locations within these zones. For example, 'Eastern Europe' and 'Western Europe'.">
							Shipping Zone <span class="glyphicon glyphicon-info-sign"></span>
						</div>
					</th>
					<th>
