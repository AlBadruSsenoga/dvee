...
<div class="page-header b-0">
	<h4 class="lead pull-left">Manage Order Statuses</h4>
	<a href="<?php echo site_url('admin/insert_order_status') ?>" class="btn btn-primary pull-right">
		<span class="glyphicon glyphicon-plus"></span> Order Status
	</a>
