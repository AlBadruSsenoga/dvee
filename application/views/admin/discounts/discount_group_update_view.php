	...
	<div class="row">
		...
		<div class="col-md-9">
			<div class="page-header b-0" style="margin-top:0">
				<div class="lead pull-left">Discount Group Items</div>
				<a href="<?php echo site_url('admin/insert_discount_group_items/'.$group_data[$this->flexi_cart_admin->db_column('discount_groups', 'id')]) ?>" class="btn btn-primary pull-right">
