...
$baseUrl = substr($currentUrl, 0, strpos( $currentUrl, '/user_guide'));

?>


<body class="navoffset" data-spy="scroll" data-target="#navbar">
    <div id="navbar" class="navmenu navmenu-default navmenu-fixed-left offcanvas-sm" style="padding-top:10px">
		...
		<ul class="nav navmenu-nav">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu navmenu-nav">
                    <li><a href="#item-category">Categories</a></li>
                    <li><a href="#item-attributes">Attributes</a></li>
                    <li><a href="#add-items">Adding Products</a></li>
                    <li><a href="#edit-items">Editing Products</a></li>
                    <li class="divider"></li>
                </ul>
            </li>
			<li class="dropdown">
                ...
                <ul class="dropdown-menu navmenu-nav">
					<li class=""><a href="#orders">Managing Orders</a></li>
					<li class=""><a href="#order-statuses">Order Statuses</a></li>
					<li class=""><a href="#locations">Managing Locations</a></li>
					<li class=""><a href="#location-types">Location Types</a></li>
					<li class=""><a href="#location-zones">Location Zones</a></li>
					<li class=""><a href="#shipping-options">Managing Shipping Options</a></li>
					<li class=""><a href="#taxes">Managing Taexs</a></li>
                </ul>
			</li>
			<li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                ...
                <ul class="dropdown-menu navmenu-nav">
					<li class=""><a href="#discounts">Discounts</a></li>
					<li class=""><a href="#reward-points">Reward Points & vouchers</a></li>
                </ul>
			</li>
			<li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                    Store Front <span class="caret"></span>
                </a>
                <ul class="dropdown-menu navmenu-nav">
					<li class=""><a href="#pages">Managing Pages</a></li>
					<li class=""><a href="#banners">Managing Banners</a></li>
                </ul>
			</li>
		</ul>
		<hr>
		<ul class="nav navmenu-nav">
			...
			<li class=""><a href="#paypal">PayPal</a></li>
		</ul>
    </div>
